...
namespace beastie {
    ...
    */
        ...
        public void PrintChart(TextWriter output) {
            output.WriteLine("<!-- Auto-generated by [[User:Beastie Bot]]. -->");
            ...
            */
            ...
            if (subHeadings.Count() > 0) {
                ...
                if (anyBinoms) {
                    ...
                    output.WriteLine(FormatBitriList(deepBitriList.Where(bt => bt.isSpecies), status));
                } else {
                ...
                if (anySubspecies) {
                    ...
                    output.WriteLine(FormatBitriList(deepBitriList.Where(bt => bt.isTrinomial && !bt.isStockpop), status));
                }
                ...
                if (anyStockPops) {
                    ...
                    //}
                    output.WriteLine(FormatBitriList(grouped, status));
                }
                output.WriteLine(string.Empty);
        ...
        public string FormatBitriList(IEnumerable<IUCNBitri> bitris, RedStatus filter = RedStatus.Null) {
            if (bitris.Count() == 0)
                return string.Empty;
        ...
        public string FormatBitri(IUCNBitri bitri, RedStatus filter = RedStatus.Null) {
            ...
            if (filter.Limited() == RedStatus.Null || filter == RedStatus.CR || filter == RedStatus.EXplus) {
            ...
            bool includeStatus = filter.Limited() == RedStatus.Null;
            string extinct = "";
            if (includeStatus) {
