...
namespace beastie
{
	...
	public static class StringHelper
	{
		...
		/// </returns>
		// --------------------------------------------------------------------------------
		public static string UnescapeCSharpLiteral(this string source)
		{
		...
		/// </returns>
		// --------------------------------------------------------------------------------
		public static string UnescapeVerbatimLiteral(this string source)
		{
			StringBuilder sb = new StringBuilder(source.Length);
			int pos = 0;
			while (pos < source.Length)
		...
		{
			string result = source.UnescapeCSharpLiteral();
			if (result.Length != 1)
