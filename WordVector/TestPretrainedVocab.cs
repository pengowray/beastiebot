...
namespace beastie.WordVector {
    class TestPretrainedVocab {
        ...
        public void TestAll() {
            ...
            //TODO: text vocab files: max digits before and after the decimal place (separately for positive and negative)
            //TODO: binary vocab files: will it fit in a half-precision float: number of used exponent bits and fraction bits, or convert to Half and back.
